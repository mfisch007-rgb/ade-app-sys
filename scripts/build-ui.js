...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, monospace; }
    ...
    .brand h1 { font-size: 22px; font-weight: 800; color: var(--text); display: flex; align-items: center; gap: 10px; }
    .brand p { font-size: 12px; color: var(--text-muted); margin-top: 4px; letter-spacing: 0.5px; }
    ...
    .shortcut-hint { background: #1e293b; padding: 4px 8px; border-radius: 4px; font-size: 11px; color: var(--accent); cursor: pointer; }
    ...
    .palette-item { padding: 12px 16px; border-radius: 6px; display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: all 0.15s ease; }
...
<body>
  <header>
    ...
    <div class="badge">11/11 KERNEL SUBSYSTEMS ACTIVE</div>
  </header>
  <div class="grid">
  ...
  <div class="main-layout">
    <div class="panel">
      <div class="panel-title">
        ...
        <span class="shortcut-hint" onclick="togglePalette()">Ctrl + K (Launch Command OS)</span>
      </div>
  ...
  <footer>
    <span>ADE Hybrid Human-AI Architecture &copy; 2026</span>
    <span>Press <kbd style="background:#1e293b; padding:2px 6px; border-radius:4px; color:var(--accent)">Ctrl + K</kbd> to trigger Command Surface</span>
  </footer>
  ...
  <script>
    ...
    function closePalette(e) { overlay.style.display = 'none'; }
